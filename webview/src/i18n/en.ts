export const en = {
  ...
  explainRegexStructureTitle: 'Current pattern (AST outline)',
  explainRegexParseErrorFmt: 'Parse error: {detail}',
  explainRegexEmptyPattern: '(empty pattern)',
  explainRegexFlagsLineFmt: 'Flags: {flags}',
  explainRegexFlagsNone: '(none)',
  explainRegexOutlineCapturingFmt: 'Capturing group: {snippet}',
  explainRegexOutlineGroupFmt: 'Group: {snippet}',
  explainRegexOutlineAssertionFmt: 'Assertion: {snippet}',
  explainRegexOutlineCharClassFmt: 'Character class: {snippet}',
  explainRegexLexerLineFmt: '{type}: {value}',
  explainRegexTokEscape: 'escape',
  explainRegexTokClass: 'character class',
  explainRegexTokGroup: 'parens',
  explainRegexTokQuant: 'quantifier',
  explainRegexTokAlt: 'alternation',
  explainRegexTokAnchor: 'anchor',
  explainRegexTokDot: 'dot',
  explainRegexTokText: 'literal',
